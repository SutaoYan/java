...
import com.sutao.database.jdbc.Person;
...
public class UsePerson {
  private List<String> names = Arrays.asList("Joffrey Baratheon", "Daenerys Targaryen", "Jon Snow",
          "Arya Stark", "Tyrion Lanister", "Margaery Tyrell");
