...
public class JavaTimeDemos {
  public static void main(String[] args) {
    ...
    System.out.println("First day of spring this year falls on a " + firstDayofSpring.getDayOfWeek());

    // until with ChronoUnit gives days between
    long gap = groundHogDay.until(firstDayofSpring, ChronoUnit.DAYS);
    System.out.println("There are " + gap + " days between GroundHog day and 1st day of spring");
    System.out.println("That's " + (gap/7) + " week and " + (gap%7) + " days");
    ...
    ZonedDateTime spring = ZonedDateTime.of(2016, 3, 20, 0, 0, 0, 0, ZoneId.systemDefault());
